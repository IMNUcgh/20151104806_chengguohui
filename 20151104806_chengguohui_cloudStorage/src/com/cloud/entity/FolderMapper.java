...
public interface FolderMapper
{
	...
	/**
	 * 获取已被用户删除的所有文件夹
	 * @return 返回已被用户删除的所有文件夹
	 */
	public List<Folder> selectDeletedFolder();
	...
	public void deleteFolderByIdFromRecycleBin(Integer id);
	
	//根据父文件夹筛选出其中所有的文件夹
	public List<Folder> selectAllFolderByFatherFolder(Folder fatherFolder);

	public Folder selectNewestFolder(Folder fatherFolder);
